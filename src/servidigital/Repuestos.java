 ...
 * @author wiZa
 */
public class Repuestos extends javax.swing.JDialog {
    private Repuestos R;
     ...
     * @param modal
     */
    public Repuestos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public final void cargarRepuestos() {
        if(aSel)
            tblRepuestos.setModel(new Repuesto().Tabla(txtBuscar.getText(), depo));
        else
            tblRepuestos.setModel(new Repuesto().Tabla(txtBuscar.getText()));
    }
    /**
    ...
    private void btnCrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCrearActionPerformed
        RepuestoCrear Crear = new RepuestoCrear(null,true);
        Crear.setDefault(txtBuscar.getText());
        Crear.setVisible(true);
    }//GEN-LAST:event_btnCrearActionPerformed

    private void btnOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOKActionPerformed
        if(tblRepuestos.getSelectedRow() >= 0) {
            ID = tblRepuestos.getValueAt(tblRepuestos.getSelectedRow(), 0).toString();
            if(aSel) {
                aSel = false;
                dispose();
            }
            else {
                new RepuestoEditar(null,true).setVisible(true);
            }
        }
        else {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Repuestos dialog = new Repuestos(new javax.swing.JFrame(), true);
