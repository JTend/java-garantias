...
public class Reporte {
    ...
    public Reporte(String NOMBRE, Map Parametros) {
    ...
    public void runReporte(String Titulo, Boolean Visualizar) {
        try {
            ...
            Master = (JasperReport)JRLoader.loadObject(JRLoader.getResourceInputStream("servidigital/Reportes/" + url));
        ...
        /*catch(NullPointerException ee) {
            ...
            JOptionPane.showMessageDialog(null,ee.getMessage(),"NullPointerException",JOptionPane.ERROR_MESSAGE);
        }
    }
}
